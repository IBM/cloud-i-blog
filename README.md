...
![Create IBM i Sample Project in Ansible Tower](https://github.com/IBM/cloud-i-blog/blob/master/resources/pic/misc/ansible-automation-tower-1.png)

After the project has been created, you need to define Template to run particular tasks. In the Template, you need to select the playbook from drop down menu of PLAYBOOK option. The list of playbook files are automatically loaded from GitHub repository. 
![Create IBM i Sample Template in Ansible Tower](https://github.com/IBM/cloud-i-blog/blob/master/resources/pic/misc/ansible-automation-tower-2.png)
You could launch the tasks when everything is configured. 
![Run IBM i Sample Tasks in Ansible Tower](https://github.com/IBM/cloud-i-blog/blob/master/resources/pic/misc/ansible-automation-tower-3.png)
